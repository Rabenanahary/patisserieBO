							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="upload.php" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="pos-rel">
												<input class="typeahead scrollable" type="text" name="noms" placeholder="" />
											</div>
										</div>
									</div>
									
										<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right">Recette</label>

										<div class="col-sm-9">
											<div class="pos-rel">
												<input class="typeahead scrollable" type="text" name="recette" placeholder="" />
											</div>
										</div>
									</div>
									<div class="form-group">
												<input class="typeahead scrollable" type="submit" placeholder="" value="Insérer" />											
									</div>
